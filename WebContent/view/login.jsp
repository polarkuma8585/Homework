...
<body>    
    <div style="position:relative; width:1200px; height:867px; margin:0 auto; font-family: 'Nanum Gothic', sans-serif;">
        <form id="frm" name="frm" action="testlist.do" method="post">
            ...
            <table cellpadding="5px" style="position:absolute; top:0px; left:150px; separate; border-spacing: 0 30px 0 20px;">
                <tr>                  
                    <th><input type="text" placeholder="내용을 입력해주세요." style="width:300px; height:50px; border-radius: 5px; border:1px solid #cccccc; padding:0 0 0 10px;"></th>
                </tr>
                <tr>
                    <th><input type="text" placeholder="내용을 입력해주세요." style="width:300px; height:50px; border-radius: 5px; border:1px solid #cccccc; padding:0 0 0 10px;"></th>
                </tr>
